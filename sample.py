...
pygame.display.set_caption('Invarders Game')
...
enemyX_change, enemyY_change = random.randint(1, 8), 40
...
while running:
    ...
    if enemyY > 440:
        ...
        score = font.render("GameOver", True, (255,255,255)) # テキストを描画したSurfaceの作成
